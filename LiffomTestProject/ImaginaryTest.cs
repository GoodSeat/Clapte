...
namespace GoodSeat.LiffomTestProject
{
    ...
    public class ImaginaryTest
    {
        ...
        public void CalculateImaginaryTest()
        {
            ...
            DeformTokenTest.DeformTest(token, "-(2i)^(2i)",         "-0.00792789471147588-0.0424804804251517*i");
            DeformTokenTest.DeformTest(token, "(-2i)^(2i)",         "4.24532146387436+22.7479427903525*i");
            DeformTokenTest.DeformTest(token, "(-2)^(2i) * i^(2i)", "1.48048893566918E-05+7.93298644094126E-05*i");
            ...
            DeformTokenTest.DeformTest(token, "atan(2i)",           "1.5707963267949+0.549306144334055*i");
        }
    }
}
